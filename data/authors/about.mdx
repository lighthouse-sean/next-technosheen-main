...
Designing, implementing, and maintaining custom web applications for our clients using both Hubspot and Adobe Experience Manager; as well as providing ongoing support and maintenance for existing systems. Working closely with cross-functional teams to ensure that all stakeholders are involved and informed throughout the development process, while delivering successful projects on time and within budget.
